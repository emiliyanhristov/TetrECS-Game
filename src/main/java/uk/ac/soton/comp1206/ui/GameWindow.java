...
public class GameWindow {
    ...
    /**
     * Start the single player challenge
     */
    ...
    /**
     * Start the multiplayer lobby
     */
    public void startMultiplayerLobby() { loadScene(new MultiplayerLobbyScene(this)); }
    ...
    /**
     * Start the settings and options menu
     */
