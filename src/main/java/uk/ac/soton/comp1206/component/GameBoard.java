...
public class GameBoard extends GridPane {
    ...
    private RightClickListener rightClickListener = null;
    ...
    protected void build() {
        ...
        blocks = new GameBlock[this.cols][this.rows];
    ...
    protected GameBlock createBlock(int x, int y) {
        ...
        //Unhovers from the block
        block.setOnMouseExited((e) -> {unhover(block);});

        return block;
    }

    //Method to add the hovering mechanism to the game board
    public void hover(GameBlock gameBlock){
        if(this.hoveredBlock != null){
            unhover(this.hoveredBlock);
        }
    ...
    public void setOnRightClick(RightClickListener listener){rightClickListener = listener;}
    ...
    //Method to trigger when a block is right clicked
    public void blockClickedRight(MouseEvent event, GameBlock block){
        logger.info("Right click block: {}", block);
